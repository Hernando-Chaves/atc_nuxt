  ...
  <div>
    <div class="carousel rounded relative overflow-hidden shadow-xl">
      <div class="carousel-inner relative overflow-hidden w-full">
        ...
        />
        <div
          class="carousel-item absolute opacity-0 bg-center flex items-center justify-end"
          style="height:500px; background-image: url(https://mdbootstrap.com/img/new/slides/043.jpg)"
        >
          <div class="bg-pink-100 w-96 h-64 ml-48"></div>
          <!-- <div class="bg-gray-100 w-64 h-64"></div> -->
        </div>
        <label
          for="carousel-1"
